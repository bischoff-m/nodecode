...
// TODO: close dropdown when `NodeCanvas` is moved or scaled (or move and scale dropdown as well?)
//        -> better option: use redux to track `NodeCanvas` state and pass canvasOrigin to positionDependencies prop of SelectField
